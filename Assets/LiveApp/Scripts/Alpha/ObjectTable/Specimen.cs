...
public class Specimen : MonoBehaviour
{
    ...
    Transform layout => transform.parent.transform.Find("Grid Layout");
    ...
    {   
        ...
        foreach (Transform child in transform)
        {
            ...
            if (child.name == "CheckMark") continue;
        ...
        transform.SetParent(layout.transform);
